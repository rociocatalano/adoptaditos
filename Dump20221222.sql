...
CREATE TABLE `mascotas` (
  ...
  `usuarios_refugio_id` int DEFAULT NULL,
  `usuarios_adoptante_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuarios_refugio_id_idx` (`usuarios_refugio_id`),
  KEY `usuarios_adoptantes_id_idx` (`usuarios_adoptante_id`),
  CONSTRAINT `usuarios_adoptantes_id` FOREIGN KEY (`usuarios_adoptante_id`) REFERENCES `usuarios_adoptantes` (`int`),
  CONSTRAINT `usuarios_refugio_id` FOREIGN KEY (`usuarios_refugio_id`) REFERENCES `usuarios-refugios` (`id`)
...
INSERT INTO `mascotas` VALUES ('543c2857-5b5a-4e61-b016-bb9ecfdc8a23','Lola','gato',11,'mediano','Flores',0,'F','ninguno','2022-12-22 23:30:34','2022-12-22 23:30:34',NULL,NULL),('8b452d05-5c3b-427d-845c-99d71dc7e953','Lola','gato',11,'mediano','Flores',0,'F','ninguno','2022-12-22 23:39:22','2022-12-22 23:39:22',NULL,NULL);
...
-- Dump completed on 2022-12-22 21:51:59
